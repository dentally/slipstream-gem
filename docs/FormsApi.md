...
| ------ | ------------ | ----------- |
| [**add_form_to_group**](FormsApi.md#add_form_to_group) | **POST** /sites/{SiteSlug}/forms/users/{UserSlug}/groups/{GroupSlug}/forms | Add a form to a form group, or reset it if it already exists (allowing it to be refilled) |
...
> <FormDetailsResponse> add_form_to_group(site_slug, user_slug, group_slug, create_forms_request)
...
begin
  # Add a form to a form group, or reset it if it already exists (allowing it to be refilled)
  result = api_instance.add_form_to_group(site_slug, user_slug, group_slug, create_forms_request)
  p result
...
> <Array(<FormDetailsResponse>, Integer, Hash)> add_form_to_group_with_http_info(site_slug, user_slug, group_slug, create_forms_request)
