...
module SlipstreamClient
  ...
  class PracticeSiteDetails
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SlipstreamClient::PracticeSiteDetails`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'google_tags')
        self.google_tags = attributes[:'google_tags']
      end
    end
    ...
    def valid?
      ...
      return false if @site_slug.to_s.length > 20
    ...
    # Custom attribute writer method with validation
    # @param [Object] pms_specific_site_id Value to be assigned
    def pms_specific_site_id=(pms_specific_site_id)
      if pms_specific_site_id.nil?
        fail ArgumentError, 'pms_specific_site_id cannot be nil'
      end

      @pms_specific_site_id = pms_specific_site_id
    end
    ...
    def hash
      [practice_management_software, pms_specific_site_id, site_slug, owning_organisation_slug, billing_organisation_slug, name, address, postal_address, coordinates, phone_number, email_address, application_version, currency, google_place_id, site_status, logo_url, website_url, privacy_policy_url, time_zone, google_tags].hash
    end
