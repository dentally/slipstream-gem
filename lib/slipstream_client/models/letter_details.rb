...
module SlipstreamClient
  class LetterDetails
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SlipstreamClient::LetterDetails`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] letter_id Value to be assigned
    def letter_id=(letter_id)
      if letter_id.nil?
        fail ArgumentError, 'letter_id cannot be nil'
      end
