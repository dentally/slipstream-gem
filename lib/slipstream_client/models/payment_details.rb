...
module SlipstreamClient
  ...
  class PaymentDetails
    ...
    # The payment id issued by the payment provider
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SlipstreamClient::PaymentDetails`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, payment_provider, payment_intent_id, reference, amount, currency, payment_status, session_status, intent_status, customer_id, statement_descriptor, fee_amount, history].hash
    end
