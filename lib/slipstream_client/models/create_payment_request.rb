...
module SlipstreamClient
  ...
  class CreatePaymentRequest
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SlipstreamClient::CreatePaymentRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [currency, customer_id, reference, statement_descriptor, fee_amount, line_items, ui_mode, success_url, cancel_url].hash
    end
