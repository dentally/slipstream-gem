...
module SlipstreamClient
  ...
  class PostLetterRecordIdentity
    ...
    attr_accessor :address_validation_status
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SlipstreamClient::PostLetterRecordIdentity` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SlipstreamClient::PostLetterRecordIdentity`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'address_validation_status')
        self.address_validation_status = attributes[:'address_validation_status']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          address_validation_status == o.address_validation_status &&
    ...
    def hash
      [id, pms_specific_id, address_validation_status, problem_details].hash
    end
