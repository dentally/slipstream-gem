...
module SlipstreamClient
  ...
  class FormDetailsResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'initial_state')
    ...
    # Custom attribute writer method with validation
    # @param [Object] initial_state Value to be assigned
    ...
    def hash
      [current_state, response_file_url, submitted_date, started_date, slug, type, type_id, display_name, initial_state].hash
    end
