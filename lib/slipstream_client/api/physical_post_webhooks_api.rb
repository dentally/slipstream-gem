  ...
  class PhysicalPostWebhooksApi
    ...
    def get_physical_post_subscription_with_http_info(site_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling PhysicalPostWebhooksApi.get_physical_post_subscription, the character length must be smaller than or equal to 20.'
      end
    ...
    def subscribe_to_physical_post_with_http_info(site_slug, webhook_subscription, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling PhysicalPostWebhooksApi.subscribe_to_physical_post, the character length must be smaller than or equal to 20.'
      end
    ...
    def unsubscribe_to_physical_post_with_http_info(site_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling PhysicalPostWebhooksApi.unsubscribe_to_physical_post, the character length must be smaller than or equal to 20.'
      end
