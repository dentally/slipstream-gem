...
module SlipstreamClient
  class FormsApi
    ...
    def add_form_to_group(site_slug, user_slug, group_slug, create_forms_request, opts = {})
      data, _status_code, _headers = add_form_to_group_with_http_info(site_slug, user_slug, group_slug, create_forms_request, opts)
      data
    end
    ...
    def add_form_to_group_with_http_info(site_slug, user_slug, group_slug, create_forms_request, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.add_form_to_group, the character length must be smaller than or equal to 20.'
      end
    ...
    def create_form_group_with_http_info(site_slug, user_slug, create_form_group_request, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.create_form_group, the character length must be smaller than or equal to 20.'
      end
    ...
    def create_user_and_forms_with_http_info(site_slug, create_user_with_forms_request, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.create_user_and_forms, the character length must be smaller than or equal to 20.'
      end
    ...
    def delete_form_with_http_info(site_slug, user_slug, group_slug, form_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.delete_form, the character length must be smaller than or equal to 20.'
      end
    ...
    def delete_form_group_with_http_info(site_slug, user_slug, group_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.delete_form_group, the character length must be smaller than or equal to 20.'
      end
    ...
    def delete_user_and_forms_with_http_info(site_slug, user_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.delete_user_and_forms, the character length must be smaller than or equal to 20.'
      end
    ...
    def get_form_group_with_http_info(site_slug, user_slug, group_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.get_form_group, the character length must be smaller than or equal to 20.'
      end
    ...
    def get_form_user_with_http_info(site_slug, user_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.get_form_user, the character length must be smaller than or equal to 20.'
      end
    ...
    def get_group_form_details_with_http_info(site_slug, user_slug, group_slug, form_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.get_group_form_details, the character length must be smaller than or equal to 20.'
      end
    ...
    def get_user_form_details_with_http_info(site_slug, user_slug, form_type_or_id, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.get_user_form_details, the character length must be smaller than or equal to 20.'
      end
    ...
    def list_form_groups_for_user_with_http_info(site_slug, user_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.list_form_groups_for_user, the character length must be smaller than or equal to 20.'
      end
    ...
    def list_form_users_with_http_info(site_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.list_form_users, the character length must be smaller than or equal to 20.'
      end
    ...
    def list_forms_in_group_with_http_info(site_slug, user_slug, group_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.list_forms_in_group, the character length must be smaller than or equal to 20.'
      end
    ...
    def update_form_user_with_http_info(site_slug, user_slug, update_form_user_request, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling FormsApi.update_form_user, the character length must be smaller than or equal to 20.'
      end
