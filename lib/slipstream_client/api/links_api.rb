  ...
  class LinksApi
    ...
    def create_short_links_with_http_info(site_slug, shorten_link_request, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling LinksApi.create_short_links, the character length must be smaller than or equal to 20.'
      end
    ...
    def delete_short_link_with_http_info(site_slug, link_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling LinksApi.delete_short_link, the character length must be smaller than or equal to 20.'
      end
      ...
      if @api_client.config.client_side_validation && link_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "link_slug" when calling LinksApi.delete_short_link, the character length must be smaller than or equal to 20.'
      end
    ...
    def get_short_link_with_http_info(site_slug, link_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling LinksApi.get_short_link, the character length must be smaller than or equal to 20.'
      end
      ...
      if @api_client.config.client_side_validation && link_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "link_slug" when calling LinksApi.get_short_link, the character length must be smaller than or equal to 20.'
      end
    ...
    def list_short_links_with_http_info(site_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling LinksApi.list_short_links, the character length must be smaller than or equal to 20.'
      end
