...
module SlipstreamClient
  class PhysicalPostApi
    ...
    # @param send_letter_request [Array<SendLetterRequest>] The details of the letter to send
    # @param [Hash] opts the optional parameters
    # @return [Array<(PhysicalPostSent, Integer, Hash)>] PhysicalPostSent data, response status code and response headers
    def create_letters_with_http_info(site_slug, send_letter_request, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling PhysicalPostApi.create_letters, the character length must be smaller than or equal to 20.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PhysicalPostSent'
    ...
    def get_letter_with_http_info(site_slug, letter_id, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling PhysicalPostApi.get_letter, the character length must be smaller than or equal to 20.'
      end
    ...
    def list_letters_with_http_info(site_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && site_slug.to_s.length > 20
        fail ArgumentError, 'invalid value for "site_slug" when calling PhysicalPostApi.list_letters, the character length must be smaller than or equal to 20.'
      end
