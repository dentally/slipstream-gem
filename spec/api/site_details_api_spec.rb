...
# Unit tests for OpenapiClient::SiteDetailsApi
...
describe 'SiteDetailsApi' do
  ...
  describe 'test an instance of SiteDetailsApi' do
    it 'should create an instance of SiteDetailsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::SiteDetailsApi)
    end
  end
  ...
  # unit tests for update_practice_site_capabilities
  ...
  # @param site_slug The Slipstream [slug](https://sqids.org/) that uniquely identifies a physical practice
  # @param capability The capabilities supported by the practice site
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'update_practice_site_capabilities test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
