...
# Unit tests for OpenapiClient::Forbidden
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Forbidden do
  let(:instance) { OpenapiClient::Forbidden.new }

  describe 'test an instance of Forbidden' do
    it 'should create an instance of Forbidden' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Forbidden)
    end
  end
