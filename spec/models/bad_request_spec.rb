...
# Unit tests for SlipstreamClient::BadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SlipstreamClient::BadRequest do
  let(:instance) { SlipstreamClient::BadRequest.new }

  describe 'test an instance of BadRequest' do
    it 'should create an instance of BadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SlipstreamClient::BadRequest)
    end
  end
